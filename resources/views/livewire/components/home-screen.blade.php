<div>
    ...
    >
        <div class="flex flex-col items-center justify-end flex-1 px-10 text-2xl">
            ...
            <button wire:click="loginAsRecruiter" class="flex flex-row items-center justify-center w-full p-4 mt-8 space-x-2 text-sm font-bold duration-150 transform bg-white rounded-full text-grey-100 active:scale-95">
                <img src="{{ asset('assets/logo-google.png') }}" height="15" width="15" />
                <span>Entrar como Recrutador</span>
            </button>

            <button
                wire:click="loginAsDev"
